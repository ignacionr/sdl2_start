...
#pragma region Surface
    ...
    public:
        ...
        {
            std::cerr << "Surface from a pointer" << std::endl;
        }
        ...
        ~Surface()
        {
            if (_surface)
            {
                std::cerr << "Destroying surface" << std::endl;
...
#pragma region Texture
    ...
    public:
        Texture(SDL_Renderer *renderer, Surface const &src)
        {
            ...
            std::cerr << "Texture from a surface" << std::endl;
        }
        ~Texture()
        {
            if (_texture)
            {
                ...
                std::cerr << "destroyed texture" << std::endl;
            }
        }
